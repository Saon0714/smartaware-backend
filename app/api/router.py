...
from app.api.v1.admin import invoices as admin_invoices
...
from app.api.v1.portal import invoices as portal_invoices
...
api_router.include_router(portal_invoices.router)
...
staff_router.include_router(admin_invoices.router)
